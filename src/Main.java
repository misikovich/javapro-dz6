...
public class Main {
    static List<Product> products = Arrays.asList(
            ...
            new ProductBuilder().setType("Book").setPrice(12).setCreationDate(LocalDateTime.now()).build(),
            new ProductBuilder().setType("Book").setPrice(44).setCreationDate(LocalDateTime.now()).build(),
            new ProductBuilder().setType("Book").setPrice(1132).setCreationDate(LocalDateTime.now()).build(),
            new ProductBuilder().setPrice(140).setCreationDate(LocalDateTime.now()).build(),
...
//    HashMap<String, List<Product>> groupByTypes(List<String> types) {
//        HashMap<String, List<Product>> collect = types.stream()
